	...
	Camera *camera)
{
	...
	for (int i = 0; i < NR_OF_TARGET_VIEWS; i++)
	{
...
void GeometryPass::render(float inDt)
{
	float controlSpeed;
	...
	controlSpeed = inDt / constantSpeed;
	...
	this->gDeviceContext->OMSetRenderTargets(NR_OF_TARGET_VIEWS,
